...
func Create() *cobra.Command{
	...
	createCmd.Flags().String("cloud-region", "on-premise", "region for Harvester cluster (default: on-premise)")
	...
	createCmd.Flags().String("git-owner", "holybitsllc", "git owner for repo creation")
